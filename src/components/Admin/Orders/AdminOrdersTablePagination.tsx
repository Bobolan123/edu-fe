...
interface AdminOrdersTablePaginationProps {
    totalCount: number;
    currentPage: number;
    rowsPerPage: number;
}

const AdminOrdersTablePagination: React.FC<AdminOrdersTablePaginationProps> = ({
    totalCount,
    currentPage,
    rowsPerPage,
}) => {
...
export default AdminOrdersTablePagination;