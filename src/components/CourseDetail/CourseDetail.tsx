...
export default function CourseDetail({ course, similarCourses }: ICourseDetailProps) {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={8}>
          ...
          <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
            <Chip label="Node.js" />
            <Chip label="Programming Languages" />
          ...
          <Card sx={{ position: 'sticky', top: 24 }}>
            ...
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1, mb: 2 }}>
                <Typography variant="h4">${discountedPrice.toFixed(2)}</Typography>
                <Typography variant="h6" sx={{ textDecoration: 'line-through' }} color="text.secondary">
                  ${originalPrice.toFixed(2)}
                </Typography>
                <Typography variant="body1" color="error">75% off</Typography>
              </Box>
      ...
      <Box sx={{ mt: 6, p: 3, border: 1, borderColor: 'divider', borderRadius: 1 }}>
      ...
      <Box sx={{ mt: 6 }}>
        ...
        <Box sx={{ mb: 2 }}>
          <Typography variant="body2" color="text.secondary">
            15 sections • 177 lectures • 20h 20m total length
          </Typography>
        </Box>
      ...
      {similarCourses.length > 0 && (
        <Box sx={{ mt: 8 }}>
          <Typography variant="h5" gutterBottom>Similar Courses</Typography>
